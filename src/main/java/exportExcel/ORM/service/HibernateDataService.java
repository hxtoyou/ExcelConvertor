...
/**
 * 针对Hibernate的数据服务接口，子类实现此接口中与Hibernate相关的方法.
 * 
 * @param <T>
 *            实体类型
 * @param <PK>
 ...
 */
public interface HibernateDataService<T, PK extends Serializable> extends GenericDataService<T, PK> {
	/**
